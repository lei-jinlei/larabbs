...
$.fn.extend({
	table_scroll: function(options) {
		...
		if (_trLen <= _options.rowInScrollableArea) {
			...
			var str = '<tr style="height: 1px ;width: 1px"><td  colspan="' + (_colLeng) + '" style="padding: 0;height: 0"></td><td style="padding: 0;border-width: 2px;" rowspan=' + (_options.rowInScrollableArea - _options.beginRow + 1) + ' class="croll-cell"><div class="scroll-container" style="overflow-y:scroll; display: block; height: ' + _showRowHeig + 'px;"><div style="width: 1px; height: ' + _rowHeight + 'px;"></div></div></td></tr>'
		}
